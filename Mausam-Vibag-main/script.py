...
st.title(" 📅 MAUSAM VIBHAG 🌥️ ☔ ")

col1, mid, col2 = st.columns([80, 5, 140])
with col1:
    st.write('## 📌 ️MADE BY - Akshat & Muskan ')
with col2:
    st.image('india.jpg', width=50)

st.markdown("### [GITHUB](https://github.com/akshat276/) | [LINKEDIN]("
            "https://www.linkedin.com/in/akshat-gupta-254372201/)")
